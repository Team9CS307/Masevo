...
public class TaskGetUserEvents extends AsyncTask<String, Integer, Pair<ArrayList<Event>, ArrayList<Users>>> {
    Integer errno;
    String email;

    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    @Override
    protected Pair<ArrayList<Event>, ArrayList<Users>> doInBackground(String... params) {
        email = params[0];
        String methodName;
                ...
                for (String[] aTrtd : trtd) {
                    ...
                    if (count == 1) {
                        PublicEvent p = new PublicEvent(aTrtd[1], aTrtd[2], d3, d4,
                                ...
                                Float.parseFloat(aTrtd[7]), email);
        ...
        return returnResult = new Pair<ArrayList<Event>, ArrayList<Users>>(events,users);
    }
